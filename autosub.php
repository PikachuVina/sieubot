...
<?php } else {
  ?>
      ...
      <div class="form-group">
      <label for="usr">Cài Auto Sub (Vui lòng nhập ID):</label><br>
<div class="form-group">
<input type="hidden" id="token_cua_tui" value="<?php echo $_SESSION['token']; ?>">
<textarea class="form-control" rows="1" id="ID_STATUS" value="Nhập ID Profile cần Tăng"></textarea></div>
<button type="button" class="btn btn-info" onclick="Puaru_Sub()" > Chạy Auto Sub </button><br/><br/>
...
var url = "likesub.php";
var params = "type=sub&token_cua_tui="+token_cua_tui+"&ID_STATUS="+ID_STATUS;
